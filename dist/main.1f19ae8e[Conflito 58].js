        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            $('div').on('shown.bs.tab', 'a.active', function () {
              var activeObject = $('a.active').last().attr('aria-controls'); //let selected = activeObject[activeObject.length-1].attr('aria-controls')

              console.log(activeObject); // console.log(selected.attr('aria-controls'))
