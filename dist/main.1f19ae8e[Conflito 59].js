...
function _buildTree() {
  _buildTree = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var categories, root, total, firstLevel, categoriesNode, _iterator5, _step5, category, a, categorySelected, products, stores, _iterator6, _step6, p, _iterator7, _step7, c, node, store, _iterator8, _step8, s;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            $('div').on('shown.bs.tab', 'a.active', function () {
              categorySelected = $('a.active').last().attr('aria-controls'); //let selected = activeObject[activeObject.length-1].attr('aria-controls')

              console.log(categorySelected); // console.log(selected.attr('aria-controls'))
              // categorySelected = selected.attr('aria-controls')
